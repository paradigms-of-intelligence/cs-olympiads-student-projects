...
def generate_network_custom_distribution(rnd_seed: int = 0):
    ...
    prob = [0.03/112, 0.06/112, 0.11/112, 0.2/112, 0.2/112, 0.2/112,
            0.2/112, 0.2/112, 0.2/112, 0.2/112, 0.2/112, 0.11/112,
            0.06/112, 0.03/112] * 56
    ...
    with open(NETWORK_ARCHITECTURE_FILE, "w") as f:
        ...
        for layer in range(1, len(LAYERS)):
            ...
            nr = [randint(first_layer_node, first_layer_node + prev_size - 1) for _ in range(next_size)]
